...
const amountCases: AmountCase[] = [
  ...
  { name: "solo monthly IDR", plan: "solo", period: "monthly", currency: "IDR", amount: 99_000 },
  { name: "solo monthly USD", plan: "solo", period: "monthly", currency: "USD", amount: 6 },
  { name: "solo yearly IDR", plan: "solo", period: "yearly", currency: "IDR", amount: 1_188_000 },
  { name: "solo yearly USD", plan: "solo", period: "yearly", currency: "USD", amount: 72 },
  { name: "team monthly IDR", plan: "team", period: "monthly", currency: "IDR", amount: 199_000 },
  { name: "team monthly USD", plan: "team", period: "monthly", currency: "USD", amount: 12 },
  { name: "team yearly IDR", plan: "team", period: "yearly", currency: "IDR", amount: 2_388_000 },
  { name: "team yearly USD", plan: "team", period: "yearly", currency: "USD", amount: 144 },
];
...
describe("landing pricing", () => {
  ...
  it("formats representative IDR, USD, and free prices", () => {
    expect(getLandingPrice("solo", "monthly", "IDR")).toBe("Rp 99.000");
    expect(getLandingPrice("team", "yearly", "USD")).toBe("$144");
    expect(getLandingPrice("free", "monthly", "IDR")).toBe("Rp 0");
  });

  it.each([
    ["free", 0, 0], ["solo", 99_000, 1_188_000], ["team", 199_000, 2_388_000],
