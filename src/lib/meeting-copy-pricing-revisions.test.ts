...
describe("meeting copy and pricing revisions",()=>{
  ...
  it("adds transparent illustrative social proof",()=>{const landing=read("src/app/page.tsx"); expect(landing).toContain("100+"); expect(landing).toContain("Built for freelancers and creative studios"); expect(landing).toContain("Early user stories"); expect(landing).toContain("Illustrative"); expect(landing.match(/<figure key=/g)).toHaveLength(1);});
