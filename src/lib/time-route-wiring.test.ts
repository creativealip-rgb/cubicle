...
describe("Billing-aware Waktu route wiring", () => {
  it.skip("exposes legacy Harian/Mingguan/Approvals navigation (replaced by Timer/Timesheet/Riwayat)", () => {
  ...
  it.skip("reuses legacy Activity catalog redirect (Activity UI removed)", () => {
