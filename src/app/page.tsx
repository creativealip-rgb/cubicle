...
const pricing = [
  ...
  },
  {
    ...
    price: "Rp 588rb",
    suffix: "/tahun",
    items: ["1 user", "3 workspaces", "Unlimited clients/projects/invoices", "Client portal + AI", "100 AI requests/month", "25 MB/file"],
    cta: "Pilih Solo",
    featured: true,
  },
  {
    ...
    price: "Rp 1,188jt",
    suffix: "/tahun",
    items: ["Unlimited users", "Unlimited workspaces", "Unlimited clients/projects/invoices", "Team roles", "1,000 AI requests/month", "50 MB/file"],
    cta: "Pilih Team",
    featured: false,
  },
];
