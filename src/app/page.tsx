...
const pricing = [
  {
    ...
    price: "Rp 0",
    suffix: "selamanya",
    items: ["1 user", "1 workspace", "3 klien", "5 proyek", "10 invoice/month", "No client portal or AI", "5 MB/file"],
    cta: "Mulai gratis",
    featured: false,
  },
  {
    ...
    price: "Rp 588rb",
    suffix: "/tahun",
    items: ["1 user", "3 workspaces", "Unlimited clients/projects/invoices", "Client portal + AI", "15 AI requests/day", "25 MB/file"],
    cta: "Pilih Solo",
    featured: true,
  },
  {
    ...
    price: "Rp 1,188jt",
    suffix: "/tahun",
    items: ["Unlimited users", "Unlimited workspaces", "Unlimited clients/projects/invoices", "Team roles", "500 AI requests/day", "50 MB/file"],
    cta: "Pilih Team",
    featured: false,
  },
];
