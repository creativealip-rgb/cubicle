...
export default async function PlanningPage({ searchParams }: {
  ...
  return <div className="space-y-4 sm:space-y-6">
    <PageHeader icon={WalletCards} title={t("Planning", "Planning")} description={t("Kelola anggaran 50/30/20 dan laporan keuangan pribadi.", "Manage your 50/30/20 budget and personal financial report.")} />
