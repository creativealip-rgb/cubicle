...
export function ProjectBillingTab({ project, client, invoices, baseCurrency, currencyRates, retainerPeriod = null }: { project: DialogProject; client: DialogClient; invoices: ProjectBillingInvoice[]; baseCurrency: string; currencyRates: Array<{ fromCurrency: string; rate: string }>; retainerPeriod?: RetainerPeriodView | null }) {
