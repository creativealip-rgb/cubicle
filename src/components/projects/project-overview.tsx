...
export function ProjectOverview({ project, progress, trackedMinutes, billableAmount, invoicedAmount, outstandingAmount, budgetUsed, recentTime, recentInvoices, recentFiles, editAction, locale, t }: any) {
  const kpis = [
