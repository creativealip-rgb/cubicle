...
export function ProjectHeaderActions({ project, activeProjectServiceIds, billingModelLocked, clients }: any) {
  ...
  return <div className="flex items-center gap-2">
    ...
    <ProjectEditDialog project={project} clients={clients} activeProjectServiceIds={activeProjectServiceIds} billingModelLocked={billingModelLocked} trigger={<button ref={editRef} type="button" className="hidden"/>}/>
