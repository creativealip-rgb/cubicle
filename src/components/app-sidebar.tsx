...
const navItems = [
  ...
  { label: "Support", href: "/app/support", icon: HelpCircle, group: "Komunikasi" },
  ...
  { label: "Nodes", href: "/app/nodes", icon: BellRing, group: "Personal" },
