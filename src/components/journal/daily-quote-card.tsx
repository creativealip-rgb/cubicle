...
export function DailyQuoteCard({ quote, attribution, ai, t }: {
  quote: string;
  ...
  return <section className="rounded-2xl border border-violet-200/80 bg-gradient-to-r from-violet-50 to-white p-4 dark:border-violet-900 dark:from-violet-950/40 dark:to-card">
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0 space-y-1">
        <p className="text-[11px] font-bold uppercase tracking-wider text-violet-600">{t("Quote Hari Ini", "Quote of the Day")}{ai ? " · AI" : ""}</p>
