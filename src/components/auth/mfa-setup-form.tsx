      ...
      <section className="w-full space-y-6 rounded-xl border bg-card p-6 shadow-sm">
        ...
        {done ? (
          ...
          <div className="space-y-4">
            ...
            <code className="block max-h-32 overflow-auto break-all rounded bg-muted p-3 text-xs">
              {uri}
            </code>
            {backupCodes.length > 0 && (
              <div className="space-y-2 rounded-lg border border-amber-200 bg-amber-50 p-3">
                <p className="text-sm font-medium">
                  Save recovery codes now. Each works once.
                </p>
                <code className="grid grid-cols-2 gap-1 text-sm">
