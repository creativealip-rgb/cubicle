...
- Task 19 — browser QA partial. Desktop/mobile pagination 10/2, scoped Project/Invoice persistence, Portal owner lifecycle, full Template/item lifecycle/reorder, and zero-selection import guard passed 4/4; remaining legacy/unauthorized Portal, Task edits, stale import, origins, and formatting pending. Evidence: `docs/operations/evidence/2026-08-01-client-task-revision-final-qa.md`.
