...
async function main() {
  ...
  await page.screenshot({ path: '/root/.hermes/profiles/coder/cache/images/verify-retainer-project.png', fullPage: true });
  console.log('Screenshot saved to /root/.hermes/profiles/coder/cache/images/verify-retainer-project.png');
